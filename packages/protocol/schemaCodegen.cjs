...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/master/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.cms.editor.lsp.schema/target/schema/cms/13.2.0/cms-tsgen.json';

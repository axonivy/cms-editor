...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/cms-translation-original-value/9/artifact/workspace/ch.ivyteam.ivy.cms.editor.lsp.schema/target/schema/cms/13.2.1/cms-tsgen.json';
